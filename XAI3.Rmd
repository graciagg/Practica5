...
Respecto a la primera variable, Days since 2011, podemos observar que a medida que pasan los días desde 2011 la venta de bicicletas aumenta. No obstante, si pasan de 150 a 250 días no afecta a dicha venta. Podemos observar que a partir de 400 días las ventas se disparan, es decir, aumentan considerablemente hasta llegar a 600 días, donde las ventas empiezan a disminuir.

En cuanto a la temperatura, a medida que aumenta también aumenta la venta de bicicletas. Este crecimiento se observa hasta los 20 grados, temperatura a partir de la cual la venta empieza a disminuir. Con 20 grados, la venta predicha es de 5000 bicicletas.

Por lo que se refiere a la humedad, esta variable no afecta a las ventas si su valor está entre 0% y 50%. No obstante, si la humedad supera el 50% las ventas decrecen. A medida que la humedad aumenta, las ventas decrecen proporcionalmente.

Por último, tenemos la variable Wind speed. Esta es la velocidad del viento, la cual afecta negativamente a las ventas. A medida que aumenta la velocidad del tiempo, las ventas decrecen, hasta llegar a 20 km/hora donde las ventas se mantienen constantes, en torno a 4000 bicicletas.
